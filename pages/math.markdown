...
## <span style="color: #6666FF;">What's Desmos?</span>
...
## <span style="color: #6666FF;">Basic Graphing Functions</span>
...
### <span style="color: #6666FF;"> Linear Functions</span>
...
### <span style="color: #6666FF;">Polynomial Functions</span>
...
### <span style="color: #6666FF;">Parametric Equations</span>
...
### <span style="color: #6666FF;">Rotational wrapper functions</span>

### <span style="color: #6666FF;">Splines</span>

### <span style="color: #6666FF;">Ellipses and circles</span>

<hr>

## <span style="color: #6666FF;">Advanced Techniques</span>

### <span style="color: #6666FF;">Domain coloring</span>

### <span style="color: #6666FF;">Lag management</span>

### <span style="color: #6666FF;"></span>

### <span style="color: #6666FF;">Animating with sliders</span>

<iframe src="https://www.desmos.com/calculator/wyvgcujo4p" width="100%" style="min-height:400px"></iframe>

### <span style="color: #6666FF;">3-D rendering</span>


### <span style="color: #6666FF;">Animating 3-D Graphing</span>

<iframe src="https://www.desmos.com/calculator/yl7ftbic4g" width="100%" style="min-height:400px"></iframe>

### <span style="color: #6666FF;">Physics engines</span>

### <span style="color: #6666FF;">Adding texture with Fourier and brownian noise</span>

### <span style="color: #6666FF;">Free style parametrics</span>


<hr>

## <span style="color: #6666FF;">Artistic Vision in Desmos</span>

### <span style="color: #6666FF;">Knowing the limitations</span>

### <span style="color: #6666FF;">High density lossy rendering </span>
